<?php
$currPage = 'back_Dedicated';
include BASE_PATH . 'app/controller/PageController.php';
include BASE_PATH . 'app/manager/customer/dedicated/index.php';
?>
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <div class="row">
                ...
                <?php
                $SQL = $db->prepare("SELECT * FROM `dedicated` WHERE `user_id` = :user_id AND `deleted_at` IS NULL ORDER BY `id` DESC");
                        ...
                        <div class="col-12 col-xl-3">
                            <div class="card text-center shadow mb-5">
                                        ...
                                        <div class="col">
                                            <h3 class="mb-0">
                                                ...
                                                <?php if(is_null($row['custom_name'])){ ?>
                                                    <b>Dedicated</b> #<?= $row['id']; ?> <span data-toggle="tooltip" title="Eigenen Produkt-Namen setzen"><i style="cursor:pointer;" data-toggle="modal" data-target="#productModal<?= $row['id']; ?>" class="far fa-edit"></i></span>
                                                <?php } else { ?>
                                ...
                                <div class="card-footer">
                                    <div class="row align-items-center text-center">
                                        <div class="col-md-6">
                                            <?php if($row['state'] == 'order' | !is_null($row['locked'])){ ?>
                                                <button disabled="" class="btn btn-block btn-outline-primary">
                                                    <b>Verwalten</b>
                                                </button>
                                            <?php } else { ?>
                                                <a href="<?= env('URL'); ?>manage/dedicated/<?= $row['id']; ?>" class="btn btn-block btn-outline-primary">
                                                    <b>Verwalten</b>
                                                </a>
                                            <?php } ?>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php } else { ?>
                                                <a href="<?= env('URL'); ?>renew/dedicated/<?= $row['id']; ?>" class="btn btn-block btn-outline-primary">
                                                    <b>Verlängern</b>
                                                </a>
                                            <?php } ?>
                                        </div>
                    ...
                    <div class="alert alert-dark text-center" role="alert">
                        ...
                        <div class="alert alert-light text-center" role="alert">
                            ...
                            <h1 class="alert-heading">
                                <br>
                                Du hast aktuell noch keinen Dedicated Server 😲
                            </h1>
                            <br>
                            <h4>
                                Miete dir jetzt einen Prepaid Dedicated Server bei uns!
                            </h4>
                            <br>
                            <p>
                                <a href="<?= env('URL'); ?>order/dedicated" class="btn btn-outline-primary text-uppercase font-weight-bolder pulse-red">Jetzt bestellen</a>
                            </p>
                        </div>
                    </div>
                    <?php } ?>
